            ...
            <main className="max-w-3xl mx-auto px-6 pt-40 pb-32">
                ...
                <div className="space-y-12">
                    ...
                    <section>
                        ...
                        <p className="text-zinc-400 text-[15px] leading-relaxed">
                            In no event shall Flowivate or its suppliers be liable for any damages arising out of the use or inability to use the materials on Flowivate, even if Flowivate has been notified of the possibility of such damage.
                        </p>
                    </section>
