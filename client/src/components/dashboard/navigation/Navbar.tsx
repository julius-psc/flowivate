...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-6 py-3 mx-2 my-2 rounded-xl bg-white dark:bg-gray-8x00 border border-gray-200/50 dark:border-gray-800/50 transition-all duration-200">
