...
const Ambient: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-84 h-84 bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700">
