  ...
  const Pomodoro: React.FC = () => {
    ...
    return (
      <div className="flex flex-col items-center ml-2 w-96 p-6 bg-white rounded-xl border border-gray-100">
        {/* Mode Selector */}
            ...
            <div className="relative w-64 h-64 mb-6">
              <svg className="w-full h-full" viewBox="0 0 100 100">
                <circle
                  ...
                  cy="50"
                  r="45"
                  className="fill-none stroke-gray-100 stroke-[6]"
                />
                <circle
                  cx="50"
                  cy="50"
          ...
          {showSettings && (
            <>
              ...
              <button
                type="submit"
                form="settingsForm"
                className="p-2 text-white cursor-pointer bg-indigo-600 hover:bg-indigo-700 rounded-md transition-colors"
              >
                Save
              </button>
            </>
